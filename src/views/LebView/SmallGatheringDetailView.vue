  ...
  <div class="home">
    ...
    <div class="leb-background">
      <div id="leb-smallgathering-detail">
        ...
        <div v-if="this.$store.state.authUser.users_no == this.gatheringVo.users_no"
        ...
        <div id="leb-smallgathering-detail-name" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_name }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-host-name" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_host_name }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-host-number" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_hp }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-course-choice" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.course_name }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-date" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_date }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-closing-date" class="leb-smallgathering-detail-img-right">
          ...
          <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_deadline }}</span>
        </div>
        ...
        <div id="leb-smallgathering-detail-limit" class="leb-smallgathering-detail-img-right">
          ...
          <span id="leb-smallgathering-detail-limit-gender">
            ...
            <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_gender_limit }}</span>
          </span>
          <span id="leb-smallgathering-detail-limit-age">
            <span class="leb-smallgathering-detail-title">나이</span>
            <span class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_age_limit }}</span>
          </span>
        </div>
        ...
        <div id="leb-smallgathering-detail-information">
          ...
          <div class="leb-smallgathering-detail-content">{{ gatheringVo.small_gathering_information }}</div>
        </div>
