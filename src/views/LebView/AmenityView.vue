...
export default {
  ...
  methods: {
    ...
    FacilitiesForTheDisabledList() {
      ...
      axios({
        method: "get", // put, post, delete
        url: `http://api.odcloud.kr/api/15075529/v1/uddi:ed5cbc13-b65a-49ac-b83d-cefcf9806fd3?page=1&perPage=266&returnType=json&serviceKey=I7auO7GQYlyZTrhZho8s6cvevXCz8AmynuTV9vPjdaqlO%2B3dkXjc1Hu1ABDhgXPULJW2GGwQmg74YlbG85MsZQ%3D%3D`,
        headers: { "Content-Type": "application/json; charset=utf-8" }, //전송타입
        //params: course_category_no, //get방식 파라미터로 값이 전달
        //data: course_category_no, //put, post, delete 방식 자동으로 JSON으로 변환 전달
    ...
    initMap() {
      ...
      this.convenient_facilities_list.forEach((facility) => {
        ...
        const imageSrc = facility.convenient_facilities_type_no == 1 ?  require('@/assets/img/toiletmarker.png') :
                         facility.convenient_facilities_type_no == 2 ? '@/assets/img/yellowping.png' :
