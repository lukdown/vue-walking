    ...
    <div id="ksb-achieve-All">
      <div id="yys-box">
        <div id="ksb-achieve-subTitle">
          ...
          <span
            >달성완료 {{ challenge_complete.challenge_complete_count }}/{{
              challenge_complete.challenge_count
            }}
            개</span
          >
        </div>
          ...
          <div id="ksb-achieve-bookArea">
            <div id="yys-achieve-List-box">
              <ul class="ksb-achieve-List">
                <li
                  id="ksb-achieve-imgArea"
                  v-for="item in leftColumn"
                  :key="item.id"
                >
                  <div class="yys-img-bg">
                    <img
                      :src="`${this.$store.state.apiBaseUrl}/upload/${item.saveName}`"
                      alt=""
                      class="ksb-achieve-Img"
                      v-if="item.is_challenge_t_f == 1"
                    />
                  </div>
